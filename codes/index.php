...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $pdo->prepare("INSERT INTO bill_payment (name, card_number, expdate, cvv) VALUES (?, ?, ?, ?)");
    $stmt->execute([$name, $card_number, $exp_date, $cvv]);
    ...
    // Output the generated PDF (you can save it to a file or send it as email attachment)
    $file_name = 'payment_receipt_'.date('YmdHis').'.pdf';
    file_put_contents($file_name, $output);
    // You can send this file as an email attachment or serve it for download
    
    // Redirect to a thank you page or do any further processing
...
<head>
  <meta charset="UTF-8">
  <title>CodePen - Payment Form JS</title>
  ...
  <div class="payment">
    ...
    <div class="card">
      ...
      <div class="card__name">
        <h3>Card Holder</h3>
        <p id="card-name">Mr Bedanta Nath</p>
        </div>
    ...
    <form class="form" method="post" action ="index.php">
      ...
      <div class="form__name form__detail">
        ...
        <input type="text" placeholder="eg Mr Bedanta Nath" id="name"  name = "name" maxlength="24">
      ...
      <div class="form__number form__detail">
        ...
        <input type="text" placeholder="0000 0000 0000 0000" id="number" name = "number" onkeypress="return isNumeric(event)">
      ...
      <div class="form__cvv form__detail">
        ...
        <input type="password" placeholder="0000" id="cvv" name = "cvv" maxlength="4" onkeypress="return isNumeric(event)" >
...
<!-- partial -->
  <script src='https://unpkg.com/ionicons@5.1.2/dist/ionicons.js'></script><script  src="./script.js"></script>
